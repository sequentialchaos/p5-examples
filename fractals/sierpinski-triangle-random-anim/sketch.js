...
function draw() {
  ...
  f += random(-randomBound, randomBound)
  g += random(-randomBound, randomBound)
  h += random(-randomBound, randomBound)

  triangle.a = new Point(radius * cos(f), radius * sin(f))
  triangle.b = new Point(radius * cos(g), radius * sin(g))
  triangle.c = new Point(radius * cos(h), radius * sin(h))
